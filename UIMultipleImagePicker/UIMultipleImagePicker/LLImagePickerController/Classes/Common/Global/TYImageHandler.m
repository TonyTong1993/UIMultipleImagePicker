...
#import "TYImageHandler.h"
#import "Config.h"
static CGFloat const kDefaultThumbnailWidth = 100;
@interface TYImageHandler ()
...
@end
@implementation TYImageHandler
#pragma mark -
#pragma mark - 获取授权状态
+ (TYAuthorizationStatus)requestAuthorization {
    if (iOS8Upwards) {
        return (TYAuthorizationStatus)[PHPhotoLibrary authorizationStatus];
    }
    return (TYAuthorizationStatus)[ALAssetsLibrary authorizationStatus];
}
